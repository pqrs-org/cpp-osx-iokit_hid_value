...
TEST_CASE("iokit_hid_value") {
  ...
  REQUIRE(hid_value1.get_usage_page() == pqrs::osx::iokit_hid_usage_page(5678));
  REQUIRE(hid_value1.get_usage() == pqrs::osx::iokit_hid_usage(4321));

  REQUIRE(hid_value1.conforms_to(pqrs::osx::iokit_hid_usage_page(5678), pqrs::osx::iokit_hid_usage(4321)) == true);
  REQUIRE(hid_value1.conforms_to(pqrs::osx::iokit_hid_usage_page(5679), pqrs::osx::iokit_hid_usage(4321)) == false);
  REQUIRE(hid_value1.conforms_to(pqrs::osx::iokit_hid_usage_page(5678), pqrs::osx::iokit_hid_usage(4320)) == false);
  ...
  hid_value2 = hid_value1;
  hid_value2.set_usage_page(pqrs::osx::iokit_hid_usage_page(5679));
  REQUIRE(hid_value1 != hid_value2);
